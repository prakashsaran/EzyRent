...
export default magento => ({
  ...
  //add Product Review post method
  addProductReview: (review) => magento.post('/V1/awa-mobileshop/product/reviews/', review, ADMIN_TYPE),

  //add Product To Wishlist post method
  addProductToWishlist: (wishlist) => magento.post('/V1/awa-mobileshop/wishlist', wishlist, ADMIN_TYPE),
