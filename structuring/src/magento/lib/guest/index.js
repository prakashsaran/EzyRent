import { GUEST_TYPE,ADMIN_TYPE } from '../../types';
...
export default magento => ({
  ...
  getProductReview: (productId) => magento.get(`/V1/awa-mobileshop/product/reviews/${productId}`, undefined, undefined, GUEST_TYPE),
  getStores: () => magento.get('/V1/store/storeViews', undefined, undefined, ADMIN_TYPE),
});
