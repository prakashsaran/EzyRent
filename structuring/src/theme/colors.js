export default {
  ...
  secondary: '#84c225',
  secondaryDark: '#84c225',
  /**
   * ========================= third color =========================
   * thirdLight: to be used for hover state
   * third: to be used as default button, checkbox, spinner, radio button and other component color
   * thirdDark: to be used for active state
   */
  thirdLightColor: '#f68537',
  thirdColor: '#84c225',
  thirdDarkColor: '#f68537',
  /**
