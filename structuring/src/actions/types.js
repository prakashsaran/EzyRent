...
// Custom Types
export const UI_CHANGE_STORE = 'Change_Display_Store';
export const MAGENTO_GET_STOREVIEWS = 'magento_get_storeviews';
export const MAGENTO_GET_PRODUCT_REVIEW = 'magento_get_product_review';
export const MAGENTO_ADD_PRODUCT_REVIEW = 'magento_add_product_review';
export const MAGENTO_ADD_PRODUCT_TO_WISHLIST = 'magento_add_product_to_wishlist';
