                            ...
                            <View style={styles.infoContainer}>
                                <View style={styles.propertyInfo(theme)}>
                                    ...
                                    <View style={styles.ownerInfo}>
                                        ...
                                        <TouchableOpacity onPress={()=>this.goToMyProfile()}><Text style={styles.textValue(theme)}>Red Rows Property</Text></TouchableOpacity>
                                    </View>
                                ...
                                <Timeline
                                    ...
                                    data={[
                                        {time: '05:34', title: '15 January 2020, 05:34 PM ', description: 'You paid rent of INR 25000 for this property', icon: require('../../../assets/images/step-round.png')},
                                        {time: '07:17', title: '15 December 2019, 07:17 PM ', description: 'You paid rent of INR 25000 for this property', icon: require('../../../assets/images/step-round.png')},
                                    ]}
                                />
