...
class MyProfile extends React.Component {
  ...
  renderQuickState(){
    ...
    if(AccountType!="lessee"){
      return(
        <View style={styles.shadow} title={<Text>test</Text>}>
      ...
      return (
        <ImageBackground style={{width:'100%',height:'100%'}} resizeMode={'cover'} source={require('../../assets/images/dashboard_bg.png')}>
          ...
          <TouchableOpacity onPress={()=>NavigationService.goBack()}  style={{alignItems:'center',flexDirection:'row'}}>
            ...
            <TouchableOpacity onPress={()=>this.goToEditProfile()}><Image style={styles.editButton} source={require('../../assets/images/edit-white.png')}></Image></TouchableOpacity>
          </View>
              <ScrollView
