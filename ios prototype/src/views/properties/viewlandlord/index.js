...
class ViewPropertyTenant extends React.Component {
    ...
    renderInfoTimeline(){
        return(
            <Text style={styles.payTime(theme)}>You received rent of <Text style={{color:'#000',fontSize:14,fontWeight:'bold'}}>INR 25000</Text> for this property</Text>
        )
    }
    render(){
                            ...
                            <View style={styles.infoContainer}>
                                <View style={styles.propertyInfo(theme)}>
                                    ...
                                    <View style={styles.ownerInfo}>
                                        <Text style={styles.textLabel(theme)}>Rentend to</Text>
