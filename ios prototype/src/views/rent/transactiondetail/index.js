                    ...
                    <View style={styles.formColumnWrapp}>
                      <View style={styles.transactionInf}>
                         ...
                         <View style={styles.fieldWrapp}>
                             <Text style={theme.typography.tooltip}>Transaction Number</Text>
                             <Text style={styles.responseValue(theme)}>094387483647</Text>
                          </View>


                         <View style={styles.fieldWrapp}>
                             <Text style={theme.typography.tooltip}>Amount Paid</Text>
                             <Text style={styles.responseValue(theme)}>INR 30,000</Text>
                          </View>

                         <View style={styles.fieldWrapp}>
                             <Text style={theme.typography.tooltip}>Date of Payment</Text>
                             <Text style={styles.responseValue(theme)}>15 March 2020 <Text style={theme.typography.tooltip}>|</Text> 05:34PM</Text>
                          </View>
                         ...
                         <View style={styles.fieldWrapp}>
                             <Text style={theme.typography.tooltip}>Transaction Status</Text>
                             <Text style={styles.responseValue(theme)}>Success</Text>
                          </View>

                         <View style={styles.fieldWrapp}>
                             <Text style={theme.typography.tooltip}>Mode of Transaction</Text>
                             <Text style={styles.responseValue(theme)}>Online Payment</Text>
                          </View>

                         <View style={styles.fieldWrapp}>
                             <Text style={theme.typography.tooltip}>Bank Details</Text>
                             <Text style={styles.responseValue(theme)}>ICICI (XXXX87867), Althara Branch, Trivandrum Kerala, India</Text>
                          </View>
