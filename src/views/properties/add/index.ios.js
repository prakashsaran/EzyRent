...
import {RightIconTextbox,DropDownHolder,PickerSelect,normalize,DateMonthPicker} from '../../../components';
...
renderHeader(){
  ...
  render(){
    ...
    const {mobileNumber,tenantName,houseNumber,buildingName,collectingAmount,rentduesData,rentDue,isvisiblepayinfo,availableBuildings,availableBankAccounts,rentPeriod,bankAccount,rentDueDisable,rentduesLabel,propertyImage} = this.state
      return (
                       ...
                       <View style={styles.formcolumn}>
                          ...
                          <View style={styles.fieldWrapp}>
                             ...
                             <View style={styles.currencyLabel}>
                              ...
                              <TextInput  ref={(ref) => this._collectingAmountEntry = ref} keyboardType={'numeric'} onChangeText={(collectingAmount) =>{this.setState({collectingAmount})}} value={collectingAmount} autoCorrect={false} style={[collectingAmount?styles.textInputStyle(theme):styles.textInputStyleSec(theme),{paddingLeft:50}]} placeholder={'Ex: 10,000'}/>
                              </View>
                          </View>
                          <View style={styles.fieldWrapp}>
