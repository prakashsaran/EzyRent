            ...
            <Image style={styles.congrats_img(theme)} resizeMode={'stretch'} source={require('../../../assets/images/congrats.png')}/>
              ...
              <ScrollView style={{height:theme.dimens.popupHeight}}>
                  <View style={styles.congrats_content(theme)}>
                    ...
                    <Text adjustsFontSizeToFit style={styles.light_color}> (+91-976242342)</Text>
                  </View>
                  <View style={styles.congrats_content(theme)}>
                    <Text style={styles.light_color} adjustsFontSizeToFit>Please Confirm the Total Amount Payble Monthly</Text>
                  </View>
                  ...
                  <View style={styles.total_warp}>
                    ...
                    <Text style={styles.total_amount_light} adjustsFontSizeToFit>(Rent Amount +  Bank Charge + Service Charge)</Text>
                  </View>
              </ScrollView>
