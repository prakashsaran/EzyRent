...
function RightIconTextbox(props) {
    ...
    <View style={[styles.container, props.style]}>
      <TextInput onFocus={()=>onfocusMobile()} onBlur={()=>onBlurMobile()} ref={component => _root = component} {...props} keyboardType={keyboardType} onChangeText={(textValue)=>{onChangeText(textValue)}} placeholder={placeholder} value={textValue} style={styles.inputStyle}></TextInput>
