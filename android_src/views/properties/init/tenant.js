...
class PropertiesTenant extends React.Component {
                  ...
                  <Image style={styles.dash_bar_img(theme)} resizeMode={'stretch'} source={require('../../../assets/images/dash-bar-line.png')}/>
                    ...
                    <View style={styles.timeline}>
                        <Timeline
                            ...
                            data={[
                                {time: '05:34', title: 'Amount (Includes Rent, Maintenance etc)', description:this.descriptionLoopItem(property_currentItem.rent_split_up.rent_amount,"Per Month"), icon: require('../../../assets/images/step-round.png')},
...
PropertiesTenant.navigationOptions = ({ navigation }) => ({
