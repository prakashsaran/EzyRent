...
componentDidUpdate(prevProps,prevState){
  ...
  if(prevState.rentDue !=rentDue){
    this.renderRentDayDate();
  }
}
...
renderPropertyMainImage(){
  ...
  return(<Image style={styles.headerBannerImage(theme)} source={require('../../../assets/images/add_properties.png')}/>);
}
renderHeader(){
    return(
