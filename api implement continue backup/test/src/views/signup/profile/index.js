...
import {View, Image, Text,ScrollView,SafeAreaView,TouchableOpacity,TextInput,KeyboardAvoidingView,Platform,StatusBar  } from "react-native";
      ...
      <KeyboardAvoidingView behavior={keyboardBehavior} >
          <ScrollView>
            ...
            <View style={styles.pinwrapper(theme)}>
              <Text style={styles.pintitle(theme)}>SET YOUR 4 DIGIT APP PIN</Text>
