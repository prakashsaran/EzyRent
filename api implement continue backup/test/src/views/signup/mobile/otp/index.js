...
import {View, Image, Text,ScrollView,SafeAreaView,TouchableOpacity,KeyboardAvoidingView,StatusBar,Platform } from "react-native";
...
import { resendMobileOtp,signupMobileOtp } from '../../../../actions';
...
export default connect(mapStateToProps, { resendMobileOtp,signupMobileOtp })(SignUpMobile);
