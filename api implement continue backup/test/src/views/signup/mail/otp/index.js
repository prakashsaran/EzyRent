  ...
  return (
    <SafeAreaView style={styles.container(theme)}>
      <ScrollView>
        ...
        <Text style={theme.typography.stepmessage}>Just 2 more steps and you`re done. We hate paperwork too. Validate your email address</Text>
...
export default connect(mapStateToProps, { resendMailOtp,signupMailOtp })(SignUpMobile);
